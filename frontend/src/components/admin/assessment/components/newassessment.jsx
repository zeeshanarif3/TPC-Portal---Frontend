    ...
    useEffect(() => {
        if (activeAssessment?._id) {
            setForm({
                ...
                programId: activeAssessment.programId?._id || activeAssessment.programId || "",
                skeletonId: activeAssessment.skeletonId?._id || activeAssessment.skeletonId || "",
                ...
                questions:
                    Array.isArray(activeAssessment.questions) && activeAssessment.questions.length > 0
            ...
            <div className="am-shell">
                <div className="am-header">
                    ...
                    <div className="am-header-copy">
                        ...
                        <h1>{mode === "edit" ? "Edit Assessment" : "Create New Assessment"}</h1>
                        <p>
                    ...
                    <form className="am-main" onSubmit={handleSubmit}>
                        ...
                        <section className="am-card">
                            ...
                            <div className="am-grid">
                                ...
                                <div className="am-field">
                                    <label>
                                        <CalendarDays size={14} /> Close date
                                    </label>
                                    <input
                                        type="date"
                                        value={form.deadline}
