...
export function useTrainer(token) {
    ...
    const submitAttendanceWithRefresh = useCallback(
    async (...args) => {
        try {
            const result = await submitAttendance(...args);

            // Refresh slots after attendance submission
...
//             }
//         },
//         [refreshSchedules,setSelectedDate]
//     );
...
//         })();
//     }, [refreshSchedules,refreshStudents , setSelectedDate]);
